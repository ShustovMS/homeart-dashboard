...
def build_sheet_methodology(wb):
    ...
    kw_rows = [
        ("Мебель",
         "мебель, гардероб, уличная мебель, матрас, ковры, аксессуары",
         "Мебель / Гардероб / Уличная мебель / Мебель, Ковры / Мебель, Гардероб / Аксессуары"),
        ("Кухни",
         "кухня, кухн",
         "Кухня"),
        ("Сантехника",
        ...
        ("Другие",
         ...
         "Техника / Розетки / Отделочные материалы / Другое"),
    ]
    ...
    mapping_rows = [
        ...
        ("Аксессуары",           "Мебель",                                      1, "Ключевое слово «аксессуары»"),
        ("Другое",               "Другие",                                      1, ""),
